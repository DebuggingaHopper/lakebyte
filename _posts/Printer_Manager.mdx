...
The userPrinter class serves as the printer object of the printer that will be primarly tampered with. Currently the following the barebone sbut this level of refactporing was necessray for part 2 of this article, so for now enjpy this barebones class.
