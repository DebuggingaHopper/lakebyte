...
title: Creating an application for printer troubleshooting (wow so innovative)
description: Discussing the process of creating a software that troubleshoots a printer for the user
prerequisites: ['None']
stacks: ['Git','C#','prnport']
---
