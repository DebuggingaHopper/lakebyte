...
<div className="min-h-screen space-y-1 h-full flex flex-col justify-center items-center w-30 text-wrap text-center text-base p-30">
<img src="/assets/pfp.jpg" className="w-40 h-40 rounded-full" alt="PFP picture"></img>
<p className="text-[#ffffff] font-semibold">
  Nelson Alvarez's DevOps Blog about optimizing niche problems
</p>
